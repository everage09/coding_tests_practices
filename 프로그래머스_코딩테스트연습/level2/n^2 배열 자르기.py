...
# transforming 2d array into 1d array step by step takes long time in some cases.
# hence directly compute the row, col value and get the matrix value of 1d array.
