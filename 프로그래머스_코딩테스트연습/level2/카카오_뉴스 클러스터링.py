...
# Used lists because of duplication elements, but still the code would have been simpler if sets were used.
def solution(str1, str2):
    ...
    if not (len(set1) or len(set2)):
        answer = 65536
    else:
        answer = int((cross / (len(set1)+len(set2)-cross))*65536)
    return answer
